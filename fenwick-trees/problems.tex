...
\subsection{Problema Little Artem and Time Machine (Codeforces)}
\label{problem:little-artem-and-time-machine}

\href{https://codeforces.com/contest/669/problem/E}{enunț}
$\bullet$
\hyperref[code:little-artem-and-time-machine]{sursă}

Este o problemă simplă, cu multe rezolvări. Dar \textbf{citiți atent enunțul}, care este neclar. Pentru intrarea
...
Așadar, valoarea 7 a fost adăugată la timpul 1 și ștearsă la timpul 2. Dar la momentele 10 și 11 răspunsul este 1, respectiv 0, pentru că prima interogare vine înaintea ștergerii \textbf{în ordinea din fișier}.
...
Observăm mai întîi că răspunsurile pentru fiecare valoare pot fi grupate și procesate independent. Am ales să fac asta sortînd interogările după valoare și procesînd grupuri de interogări referitoare la aceeași valoare. Pe Codeforces am tot văzut surse care se reped la \ccode{map}, dar... de ce am face asta?
...
Pentru a pregăti AIB-ul pentru o nouă valoare, trebuie să-l golim după procesarea operațiilor pentru a valoare. Putem face aceasta repetînd operațiile cu semn schimbat (-1 pentru adăugări, +1 pentru ștergeri).

Pentru a scurta codul, putem întoarce pe dos logica structurii: sortăm operațiile după timpii $t$ și indexăm AIB-ul după indicii operațiilor, $i$. Deoarece acești indici sînt deja între 1 și $n$, scăpăm de normalizare! Paradoxal, această implementare este mai lentă, deși face o sortare mai puțin. \emoji{smiling-face-with-tear}
