...
\subsubsection*{Cîteva cuvinte despre \textit{Arpa's trick}}

Eu sînt mereu în căutare de noi structuri pentru RMQ. \emoji{face-with-tears-of-joy} Îmi displace tabela rară deoarece folosește  $\bigoh(n \log n)$ memorie și evit să mă reped la ea. Iată o structură interesantă, numită \textit{Arpa's trick}. Aparent, și alte nații au șmenurile lor... CP Algorithms are \href{https://cp-algorithms.com/data_structures/disjoint_set_union.html#arpa}{o lecție} foarte bună.
