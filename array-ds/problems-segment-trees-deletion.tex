...
Rezolvarea pentru o poziție (rucsacul clasic) are complexitate de $\bigoh(qn)$, așadar efortul total este $\bigoh(qn^2)$, prea mare. Dar dacă am încerca să baleiem pozițiile de la 1 la $n$? Ca să avansăm de la poziția $i$ la $i+1$ și să actualizăm rucsacul, avem nevoie de o structură de date cu următoarele operații:

\begin{enumerate}
  \item Adaugă un obiect în rucsac (pentru intervalele care încep la $i+1$).
  \item Scoate un obiect din rucsac (pentru intervalele care se termină la $i$).
\end{enumerate}
