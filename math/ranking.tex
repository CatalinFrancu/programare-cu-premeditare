...
\label{problem:math-perm-rank}

Vom citi \hyperref[code:math-perm-rank]{implementările} acestor algoritmi. Iată și un \textit{benchmark} pentru $n = 20$:
...
\label{problem:math-comb-rank}

\hyperref[code:math-comb-rank]{Implementarea completă} este anexată.
