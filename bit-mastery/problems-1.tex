...
Se vede că scorul unei întrebări poate varia între $-n$ și $+n$. De aceea, în prima sursă chiar colectez întrebările într-un vector de liste indexat după scor. Astfel putem sorta întrebările în $\bigoh(m + n)$.
