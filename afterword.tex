% Put the Afterword outside of the last part of the book.
\bookmarksetup{startatroot}
% Omit numbering for this chapter...
\chapter*{Postfață}
% ... but the above also removes it from the ToC, so add it manually.
\addcontentsline{toc}{chapter}{Postfață}
