...
Să considerăm acum următorul deziderat: ne dorim un vector / listă / colecție indexată care să suporte următoarele operații în $\bigoh(\log n)$:
...
Pentru un exemplu de implementare, vedeți problema \hyperref[TODO]{Reversals and Sums (CSES)}.
