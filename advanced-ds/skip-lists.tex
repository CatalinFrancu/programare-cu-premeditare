...
\textit{Skip lists} sînt o structură de date originală, atipică. Pentru cei ca noi, educați exclusiv cu structuri de date deterministe, prima întîlnire cu \textit{skip lists} poate fi fascinantă, căci ele sînt o structură de date probabilistică.
