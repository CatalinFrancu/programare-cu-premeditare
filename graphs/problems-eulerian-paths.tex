...
\begin{itemize}
  ...
  \item În fiecare nod $u$ intră două arce (orientate) dinspre șirurile al căror ultimi $n-2$ biți corespund cu primii $n-2$ biți ai lui $u$.
  \item Invers, din fiecare nod $u$ ies două arce către șirurile al căror primi $n-2$ biți corespund cu ultimii $n-2$ biți ai lui $u$.
  \item Pe fiecare muchie notăm bitul care trebuie adăugat la nodul-sursă pentru a obține nodul-destinație.
  \item Intuitiv, nodul $u$ semnifică că ultimii $n-1$ biți tipăriți au fost reprezentarea binară a lui $u$.
...
Articolul de pe Wikipedia include și \href{https://en.wikipedia.org/wiki/De_Bruijn_sequence#Construction}{o imagine} pentru $n = 4$.
