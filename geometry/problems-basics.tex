...
Și această problemă este relativ elementară. Pentru a putea roti $A$ peste $B$, trebuie să alegem un centru $P$ astfel încît $PA=PB$. Așadar, $P$ trebuie să fie pe mediatoarea segmentului $AB$. Similar, $P$ trebuie să fie pe mediatoarea segmentului $BC$. În concluzie, $P$ este centrul cercului circumscris triunghiului $\Delta ABC$. De aici deducem și o primă precondiție: $A$, $B$ și $C$ nu pot fi coliniare.
