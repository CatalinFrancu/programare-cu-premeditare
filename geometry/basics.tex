...
Aplicație: \textbf{Aria unui poligon} prin două metode: (1) ca sumă de trapeze și (2) ca sumă de triunghiuri cu vîrful în origine.
...
Demonstrație: în figura de mai jos, date fiind pantele $m_1$ și $m_2$ (unde, rețineți, $m_2$ este negativă), construim punctele $Q$ și $R$ pe cele două drepte și scriem teorema lui Pitagora în triunghiul dreptunghic $PQR$:
...
Aplicație: \textbf{test de incluziune a punctului în triunghi} (sau, pe cazul general, într-un poligon convex). Testăm punctul cu fiecare latură a poligonului, $P_{i}P_{i + 1}$. Dacă punctul este în poligon, vom obține în fiecare caz același semn.
