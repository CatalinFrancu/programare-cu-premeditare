...
Dacă monstrul are o culoare și un număr de vieți, creați un \ccode{struct} cu cîmpurile \ccode{color} și \ccode{lives}. În niciun caz nu vă mulțumiți cu un \ccode{std::pair}! Vezi și \href{https://stackoverflow.com/questions/31792910/assigning-members-of-a-pair-to-variables}{structured binding}.
