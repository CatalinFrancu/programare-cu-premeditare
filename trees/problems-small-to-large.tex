...
Folosim tehnica \textit{small-to-large}, așa cum se poate deduce și din numele problemei \emoji{fox}. Este important ca fiecare fiu să stocheze $\mathcal{O}(\text{subarbore})$ informații, nu $\mathcal{O}(n)$. Deci vom folosi o tabelă hash de culori cu frecvențele lor.
